...
```sh
pip install git+https://github.com/AndyH0ng/nukki
```

다른 pip 관리 도구로 설치된 패키지와 섞이는 게 싫다면 [pipx](https://pipx.pypa.io/)로 격리 설치하는 걸 추천합니다:
...
설치 스크립트가 들어간 디렉토리(예: `~/Library/Python/3.x/bin` 또는 사용 중인 venv의 `bin/`)가
